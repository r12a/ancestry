...
function redisplay (everything, id, summary) { 
	...
	for (i=1;i<records.length;i++) {
		...
		else out += '><span class="recordDateAge">'+getAge('', info.date, year, bdate, born, '')+'</span><span class="recordDateAge" style="font-size:1px;line-height:1px;"> &bull; </span><span>'+year+'</span>'
